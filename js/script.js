...
function desenharGraficoBarras() {
    ...
    ctx.fillText(
        ...
        115,
        eixoY - alturaEntradas - 10
    );

    ctx.fillText(
        `R$ ${despesas.toFixed(2)}`,
        285,
        eixoY - alturaDespesas - 10
    );
}
